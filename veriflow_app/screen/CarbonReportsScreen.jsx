...
const distributionData = [
  { label: 'Mangrove', percentage: 45, color: '#00897B' },
  { label: 'Seagrass', percentage: 30, color: '#26A69A' },
  { label: 'Wetland', percentage: 20, color: '#4DB6AC' },
  { label: 'Salt Marsh', percentage: 5, color: '#80CBC4' },
];
    ...
    <View style={barStyles.chartContainer}>
      ...
      <View style={barStyles.legend}>
        <View style={barStyles.legendItem}>
          <View style={[barStyles.legendDot, { backgroundColor: '#00BCD4' }]} />
          <Text style={barStyles.legendText}>Issued</Text>
        </View>
        <View style={barStyles.legendItem}>
          <View style={[barStyles.legendDot, { backgroundColor: '#00796B' }]} />
    ...
    <View style={pieStyles.chartContainer}>
      <View style={pieStyles.pieChartVisual}>
        <Svg width="100%" height="100%" viewBox={`0 0 ${size} ${size}`}>
          ...
          <SvgText x={CX} y={CY - 2} fontSize={8} textAnchor="middle" fontWeight="bold" fill="#00695C">
            4
          </SvgText>
...
const StatsCards = () => {
  const stats = [
    { label: 'Total Credits', value: '4,780', change: '+12.5%', color: '#00BCD4' },
    { label: 'Active Projects', value: '24', change: '+3', color: '#00897B' },
    { label: 'Retired Credits', value: '3,050', change: '+8.3%', color: '#26A69A' },
  ];
...
const mainStyles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: 'bold', color: '#00695C', marginBottom: 8 },
  subtitle: { fontSize: 16, color: '#00897B' },
  ...
  statValue: { fontSize: 28, fontWeight: 'bold', color: '#00695C' },
  ...
  chartTitle: { fontSize: 20, fontWeight: 'bold', color: '#00695C' },
